...
describe 'navigate' do
  ...
  describe 'new' do
    it 'has a link from the homepage ' do
      employee = Employee.create(first_name: 'Non', last_name: 'Authorized', email: 'employee@example.com',
                               password: 'asdfasdf', password_confirmation: 'asdfasdf',
                               phone: "5555555555")
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'asdf', user_id: delete_user.id, overtime_request: 4.5)
      visit posts_path
  ...
  describe 'edit' do
    it 'can be edited' do
      ...
      fill_in 'post[date]', with: Date.today
      fill_in 'post[rationale]', with: "Eddited content"
      click_on "Save"

      expect(User.last.posts.last.rationale).to eq("Eddited content")
